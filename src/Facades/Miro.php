 ...
 * @method static \CodebarAg\Miro\Responses\BoardItems\BoardItemResponse getBoardItems(string $boardId, ?\CodebarAg\Miro\Dto\BoardItems\GetBoardItemsDto $params = null)
 * @method static \CodebarAg\Miro\Responses\BoardItems\BoardItemResponse getBoardItem(string $boardId, string $itemId)
